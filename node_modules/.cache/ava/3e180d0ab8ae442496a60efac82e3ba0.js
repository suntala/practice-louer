...
(0, _ava2.default)('Property sale', async t => {
    const buyer = { name: 'TestLL', money: 500, properties: [] //buyer
    };const seller = { name: 'TestR', money: 900, properties: [] };
    const inputProperty = { name: 'TestP', cost: 10 };
    ...
    // t.is(res.body[1].properties.length, 0)
});
...
//# sourceMappingURL=../../node_modules/.cache/ava/3e180d0ab8ae442496a60efac82e3ba0.js.map