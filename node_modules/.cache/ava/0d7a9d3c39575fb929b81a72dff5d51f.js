...
(0, _ava2.default)('Editing a landlord but not really', async t => {
    const input = { name: 'Test', money: 50, properties: [] };

    const creation = (await (0, _supertest2.default)(_app2.default).post('/landlord/add').send(input)).body;

    const res = await (0, _supertest2.default)(_app2.default).post('/landlord/edit').send(creation.landlordID);
...
//# sourceMappingURL=../../node_modules/.cache/ava/0d7a9d3c39575fb929b81a72dff5d51f.js.map