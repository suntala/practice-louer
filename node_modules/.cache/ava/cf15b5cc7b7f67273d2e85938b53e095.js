...
(0, _ava2.default)('Get indiv landlord page', async t => {
    ...
    //     .send(input))
    //     .body
    const landlord = await (0, _supertest2.default)(_app2.default).post('/landlord/add').send(input);
...
//# sourceMappingURL=../../node_modules/.cache/ava/cf15b5cc7b7f67273d2e85938b53e095.js.map