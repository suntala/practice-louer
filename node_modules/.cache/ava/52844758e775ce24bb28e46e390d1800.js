...
(0, _ava2.default)('Property sale', async t => {
    ...
    };const inputLandlord2 = { name: 'TestR', money: 900, properties: [] };
    const inputProperty = { name: 'TestP', cost: 10 };

    const landlordCreation1 = (await (0, _supertest2.default)(_app2.default).post('/landlord/add').send(inputLandlord1)).body;

    const landlordCreation2 = (await (0, _supertest2.default)(_app2.default).post('/landlord/add').send(inputLandlord2)).body;

    const propertyCreation = (await (0, _supertest2.default)(_app2.default).post('/property/add').send(inputProperty)).body;

    const inputAdding = { landlordID: landlordCreation2.landlordID, propertyID: propertyCreation.propertyID, payment: 0 };

    const addProperty = await (0, _supertest2.default)(_app2.default).post('/landlord/add-property').send(inputAdding);

    console.log(landlordCreation2);
...
//# sourceMappingURL=../../node_modules/.cache/ava/52844758e775ce24bb28e46e390d1800.js.map