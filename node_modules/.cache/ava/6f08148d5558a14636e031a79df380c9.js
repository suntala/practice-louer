...
(0, _ava2.default)('Edit a renter', async t => {
    ...
    const res = await (0, _supertest2.default)(_app2.default).post('/renter/edit').send(newInput);
...
(0, _ava2.default)('Delete a renter', async t => {
    const input = { name: 'Tester', money: 50, months: ['Jan'], property: ["House"] };

    const creation = (await (0, _supertest2.default)(_app2.default).post('/renter/add').send(input)).body;

    const del = await (0, _supertest2.default)(_app2.default).post('/renter/delete').send(creation);
...
//# sourceMappingURL=../../node_modules/.cache/ava/6f08148d5558a14636e031a79df380c9.js.map