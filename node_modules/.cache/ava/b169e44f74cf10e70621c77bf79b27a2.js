...
(0, _ava2.default)('Pay rent', async t => {
    ...
    const res = await (0, _supertest2.default)(_app2.default).post('/pay-rent').send(input);

    t.is(res.status, 200);
});
//# sourceMappingURL=../../node_modules/.cache/ava/b169e44f74cf10e70621c77bf79b27a2.js.map