...
(0, _ava2.default)('Edit a renter', async t => {
    ...
    };const creation = await (0, _supertest2.default)(_app2.default).post('/renter/add').send(input);

    const res = await (0, _supertest2.default)(_app2.default).post('/renter/edit').send(creation.renterID, newInput);
...
// })
//# sourceMappingURL=../../node_modules/.cache/ava/88b918b6e76189a3c68cb3b6ba3aeae4.js.map